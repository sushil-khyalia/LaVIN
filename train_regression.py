...
def main(args):
    ...
    dataset_train = MOSIDatasetForRegression(args, 'train', args.llama_model_path, args.max_seq_len)
    dataset_valid = MOSIDatasetForRegression(args, 'valid', args.llama_model_path, args.max_seq_len)
