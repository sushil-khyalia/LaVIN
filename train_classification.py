...
from engine_classification import train_one_epoch, val_one_epoch

from util.datasets import ScienceQADataSet,InstrcutDataSet,MOSIDatasetForClassification
from lavin.mm_adaptation import LaVINForClassification
import random
...
def main(args):
    ...
    dataset_train = MOSIDatasetForClassification(args, 'train', args.llama_model_path, args.max_seq_len)
    dataset_valid = MOSIDatasetForClassification(args, 'valid', args.llama_model_path, args.max_seq_len)
    ...
    # define the model
    model = LaVINForClassification(args)
